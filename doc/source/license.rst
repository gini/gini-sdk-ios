...
The Gini SDK is licensed under the MIT License (MIT) and also integrates several third party libraries. To add all license notices and permissions required to your application you can either use the prebuild files provided by CocoaPods or you can add them manually.
...
All required licenses for the Gini SDK will automatically be added to those files.
